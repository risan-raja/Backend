...
def gen_api_models(api: flask_restx.Api):
    ...
    """
    user_model = api.model('User', {'email':            fields.String(required=True,
                                    ...
                                    'current_login_at': fields.DateTime(required=True,
                                                                        description='The current login date'),
                                    'current_login_ip': fields.String(required=True,
                                                                      description='The current login IP'),
                                    'confirmed_at':     fields.DateTime(required=True,
                                                                        description='The user confirmation date'),
                                    'offline_db':       fields.Boolean(required=True,
                                                                       description='The user offline database status')})
    task_model = api.model('Task', {'title':        fields.String(required=True, description='The task title'),
    ...
    task_list_model = api.model('TaskList', {'id':          fields.String(required=True,
                                             ...
                                             'list_order':  fields.Integer(required=True,
                                                                           description='The task list index'),
                                             'created_at':  fields.DateTime(required=True,
